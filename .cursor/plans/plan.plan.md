...
- [x] Buat API Client Utility (resources/js/lib/api.js) dengan axios instance dan interceptors
- [x] Buat Auth Helper Functions (resources/js/lib/auth.js) dengan login, logout, getToken, getUser, dll
- [x] Update Form Login di AuthSwitch.jsx - ubah phone ke email, tambah state, handle submission
- [x] Update PageUtama.jsx untuk dynamic role dari localStorage
- [x] Update SidebarOrangTua.jsx untuk logout functionality
- [ ] Buat ParentDashboardController dengan method dashboard() untuk GET /api/parent/dashboard
- [ ] Tambah route /api/parent/dashboard di routes/api.php dengan middleware auth:sanctum
- [ ] Update DashboardOrangTua.jsx: tambah state management (loading, error, dashboardData)
- [ ] Implementasi fetchDashboard() function di DashboardOrangTua.jsx untuk GET data dari API
- [ ] Implementasi UI: Greeting section dengan nama ibu
- [ ] Implementasi UI: Summary cards (jumlah anak, anak berisiko)
- [ ] Implementasi UI: Children cards list dengan status gizi badge dan highlight untuk anak berisiko
- [ ] Implementasi UI: Upcoming schedules section dengan highlight untuk jadwal urgent
- [ ] Tambah loading state (skeleton/spinner) dan error handling dengan retry option
- [x] Buat API Client Utility (resources/js/lib/api.js) dengan axios instance dan interceptors
- [x] Buat Auth Helper Functions (resources/js/lib/auth.js) dengan login, logout, getToken, getUser, dll
- [x] Update Form Login di AuthSwitch.jsx - ubah phone ke email, tambah state, handle submission
- [x] Update PageUtama.jsx untuk dynamic role dari localStorage
- [x] Update SidebarOrangTua.jsx untuk logout functionality
- [ ] Tambah method children() di ParentDashboardController untuk GET /api/parent/children
- [ ] Tambah method showChild() di ParentDashboardController untuk GET /api/parent/children/{id} dengan authorization check
- [ ] Tambah routes /api/parent/children dan /api/parent/children/{id} di routes/api.php
- [ ] Buat component DataAnakList.jsx dengan state management dan fetch dari API
- [ ] Implementasi UI DataAnakList: table/list view dengan kolom nama, umur, posyandu, status gizi, aksi
- [ ] Buat component DataAnakDetail.jsx dengan state management dan fetch dari API
- [ ] Implementasi UI DataAnakDetail: identitas anak section dengan card informasi lengkap
- [ ] Implementasi UI DataAnakDetail: riwayat penimbangan section dengan tabel data lengkap
- [ ] Update routing di OrangTua.jsx untuk path anak (list) dan anak/:id (detail)
- [ ] Tambah loading, error, dan empty states untuk kedua component
- [x] Buat API Client Utility (resources/js/lib/api.js) dengan axios instance dan interceptors
- [x] Buat Auth Helper Functions (resources/js/lib/auth.js) dengan login, logout, getToken, getUser, dll
- [x] Update Form Login di AuthSwitch.jsx - ubah phone ke email, tambah state, handle submission
- [x] Update PageUtama.jsx untuk dynamic role dari localStorage
...
- [x] Update PageUtama.jsx untuk dynamic role dari localStorage
- [x] Update SidebarOrangTua.jsx untuk logout functionality
- [ ] Tambah method nutriAssist() di ParentDashboardController untuk POST /api/parent/children/{id}/nutri-assist dengan validasi dan authorization
- [ ] Integrate NutritionService di method nutriAssist() untuk mendapatkan rekomendasi menu
- [ ] Tambah TODO comment untuk integrasi AI/n8n di method nutriAssist()
- [ ] Tambah route POST /api/parent/children/{id}/nutri-assist di routes/api.php
- [ ] Buat component NutriAssistPage.jsx dengan state management untuk form dan recommendations
- [ ] Implementasi fetchChildren() di NutriAssistPage untuk GET list anak dari API
- [ ] Implementasi form UI: dropdown pilih anak, textarea bahan makanan, input date dan notes optional
- [ ] Implementasi handleSubmit() dengan parse ingredients dan POST ke API
- [ ] Implementasi UI recommendations section dengan card untuk setiap menu rekomendasi
- [ ] Tambah loading, error, dan empty states untuk NutriAssistPage
- [ ] Tambah TODO comment untuk integrasi AI/n8n di NutriAssistPage
- [ ] Update routing di OrangTua.jsx untuk menggunakan NutriAssistPage component
- [x] Buat API Client Utility (resources/js/lib/api.js) dengan axios instance dan interceptors
- [x] Buat Auth Helper Functions (resources/js/lib/auth.js) dengan login, logout, getToken, getUser, dll
- [x] Update Form Login di AuthSwitch.jsx - ubah phone ke email, tambah state, handle submission
- [x] Update PageUtama.jsx untuk dynamic role dari localStorage
...
- [x] Update PageUtama.jsx untuk dynamic role dari localStorage
- [x] Update SidebarOrangTua.jsx untuk logout functionality
- [ ] Buat migration create_consultations_table dengan kolom id, parent_id, kader_id, child_id, title, status, timestamps
- [ ] Buat migration create_consultation_messages_table dengan kolom id, consultation_id, sender_id, message, timestamps
- [ ] Buat model Consultation dengan relationships dan helper methods
- [ ] Buat model ConsultationMessage dengan relationships
- [ ] Update model User untuk tambah relationships consultationsAsParent, consultationsAsKader, consultationMessages
- [ ] Buat ParentConsultationController dengan method index() untuk GET /api/parent/consultations
- [ ] Implementasi method store() di ParentConsultationController untuk POST /api/parent/consultations
- [ ] Implementasi method show() di ParentConsultationController untuk GET /api/parent/consultations/{id}
- [ ] Implementasi method sendMessage() di ParentConsultationController untuk POST /api/parent/consultations/{id}/messages
- [ ] Tambah routes konsultasi di routes/api.php dengan middleware auth:sanctum
- [ ] Buat component ConsultationList.jsx dengan state management dan fetch dari API
- [ ] Implementasi UI ConsultationList: header, filter tabs, list view dengan card konsultasi
- [ ] Buat component ConsultationDetail.jsx dengan state management dan fetch dari API
- [ ] Implementasi UI ConsultationDetail: chat messages section dengan bubble kiri/kanan
- [ ] Implementasi form input pesan dan function sendMessage() di ConsultationDetail
- [ ] Buat component CreateConsultation.jsx untuk form buat konsultasi baru
- [ ] Update routing di OrangTua.jsx untuk path konsultasi (list, new, detail)
