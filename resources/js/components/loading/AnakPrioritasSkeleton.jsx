        ...
        <div className="min-h-screen bg-[#F8FAFC] font-montserrat">
            ...
            <div className="p-3 md:p-6">
                <div className="flex flex-col gap-6 md:gap-8 w-full max-w-7xl mx-auto">
                    ...
                    {/* Summary Cards Skeleton — 3 columns, Admin style */}
                        ...
                        {Array.from({ length: 3 }).map((_, i) => (
                            <div key={i} className="bg-white p-5 md:p-6 rounded-2xl border border-gray-100 shadow-sm">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <Shimmer className="h-5 w-20 rounded-full" delay={i * 50 + 25} />
                                </div>
                                <div>
                                    <Shimmer className="h-10 w-14 mb-2" delay={i * 50 + 50} />
                                    <Shimmer className="h-4 w-28" variant="text" delay={i * 50 + 75} />
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    {/* Search Bar Skeleton */}
                    <Shimmer className="h-12 w-full rounded-2xl" delay={200} />
                            ...
                            <div key={i} className="bg-white rounded-2xl p-5 md:p-6 shadow-sm border border-gray-100 flex flex-col">
                                ...
                                <div className="flex items-start justify-between mb-5">
                                    <div className="flex items-center gap-3">
                                        <Shimmer className="w-12 h-12 shrink-0" variant="circle" delay={i * 60} />
                                        <div>
                                            <Shimmer className="h-5 w-28 mb-1" delay={i * 60 + 20} />
                                            <Shimmer className="h-3 w-24" variant="text" delay={i * 60 + 40} />
                                        </div>
                                    </div>
                                    <Shimmer className="h-5 w-24 rounded-full" delay={i * 60 + 60} />
                                </div>

                                {/* Risk Indicators */}
                                <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-100">
                                    <Shimmer className="h-3 w-24 mb-3" variant="text" delay={i * 60 + 80} />
                                    <div className="space-y-2">
                                        <Shimmer className="h-3 w-full" variant="text" delay={i * 60 + 100} />
                                        <Shimmer className="h-3 w-3/4" variant="text" delay={i * 60 + 120} />
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-50/60 rounded-xl p-4 border border-gray-100 mb-4">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        {Array.from({ length: 3 }).map((_, j) => (
                                            <div key={j}>
                                                <Shimmer className="h-2.5 w-10 mb-1" variant="text" delay={i * 60 + 160 + j * 20} />
                                                <Shimmer className="h-4 w-14" delay={i * 60 + 180 + j * 20} />
                                            </div>
                                        ))}
                                    </div>
                                </div>
