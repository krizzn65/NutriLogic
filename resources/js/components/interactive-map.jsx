    ...
    return (
        <div className={`advanced-map ${className}`} style={style}>
            ...
            >
                    ...
                    <MarkerClusterGroup>
                        {markers.map((marker, index) => (
                            <Marker
                                ...
                                icon={
                                    marker.icon ||
                                    createCustomIcon(marker.color, marker.size)
                                }
                                eventHandlers={{
                                    click: () =>
                ...
                {/* User location marker disabled */}

                {/* Search result marker disabled */}

                {/* Clicked location marker disabled */}
                ...
                {polylines.map((polyline, index) => (
                    <Polyline
                        ...
                        pathOptions={
                            polyline.style || { color: "red", weight: 3 }
                        }
                    >
