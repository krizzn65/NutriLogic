...
const AboutUs = () => {
  ...
  return (
    <div className='font-poppins min-h-screen flex items-center w-full bg-white overflow-hidden' id='About'>
      ...
      <section ref={sectionRef} className='w-full px-6 sm:px-12 lg:px-20 xl:px-32 py-24 lg:py-32'>
        <div className='max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center gap-20 lg:gap-32'>
