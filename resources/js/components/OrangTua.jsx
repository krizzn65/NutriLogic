...
const DashboardOrangTuaContent = lazy(
    () => import("./konten/DashboardOrangTua"),
);
                ...
                >
                    <Suspense fallback={<PageLoader />}>
                        <Routes>
                            <Route
                                index
                                element={<DashboardOrangTuaContent />}
                            />
                            <Route path="anak" element={<DataAnakList />} />
                            <Route
                                path="anak/tambah"
                                element={<TambahAnakForm />}
                            />
                            <Route
                                path="anak/edit/:id"
                                element={<EditAnakForm />}
                            />
                            <Route
                                path="anak/:id"
                                element={<DataAnakDetail />}
                            />
                            <Route
                                path="nutri-assist"
                                element={<NutriAssistPage />}
                            />
                            <Route
                                path="jurnal-makan"
                                element={<JurnalMakanPage />}
                            />
                            <Route
                                path="konsultasi"
