...
export default function NutriAssistPage() {
    ...
    const [selectedChildHasWeighing, setSelectedChildHasWeighing] = useState(true);
    ...
    useEffect(() => {
        const checkWeighingData = async () => {
            ...
            try {
                const response = await api.get(`/parent/children/${selectedChildId}`);
                const childData = response.data.data;
                const hasWeighing = childData.weighing_logs && childData.weighing_logs.length > 0;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            } else if (err.response?.status === 422 && err.response?.data?.requires_weighing) {
                            ...
                            <div className="relative flex flex-col md:flex-row gap-4 items-start md:items-center">
                                ...
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                        <h3 className="font-bold text-gray-800 text-lg">Smart Meal Planner</h3>
                                    ...
                                    <p className="text-gray-600 text-sm md:text-base max-w-2xl leading-relaxed">
                                        Asisten pintar yang membantu Anda meracik menu bergizi dari bahan yang tersedia di rumah. Hemat waktu, kurangi limbah makanan, dan pastikan nutrisi si kecil terpenuhi.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    {children.length === 0 ? (
                        ...
                        >
                            ...
                            <p className="text-gray-500 max-w-md mb-8">
                                Silakan daftarkan anak Anda terlebih dahulu di Posyandu untuk mulai menggunakan fitur Nutri-Assist.
                            </p>
                        </motion.div>
                    ) : (
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            >
                                <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-white/50 shadow-xl relative">
                                    ...
                                    {!selectedChildHasWeighing && selectedChildId && (
                                        <motion.div
                                            initial={{ opacity: 0, height: 0 }}
                                            animate={{ opacity: 1, height: "auto" }}
                                            exit={{ opacity: 0, height: 0 }}
                                            ...
                                            <div className="bg-amber-50/90 backdrop-blur-sm border-2 border-amber-200 rounded-2xl p-4">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        <h4 className="font-bold text-amber-900 mb-1">Data Penimbangan Diperlukan</h4>
                                                        <p className="text-sm text-amber-800 leading-relaxed">
                                                            Anak yang dipilih belum memiliki data penimbangan. Silakan kunjungi Posyandu untuk penimbangan pertama agar dapat menggunakan fitur Nutri-Assist.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={submitting || !selectedChildHasWeighing}
                                            ...
                                            <div className="relative flex items-center justify-center gap-2">
                                                {submitting ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <span>Memerlukan Data Penimbangan</span>
                                                    </>
                                                ) : (
                                                    <>
                                        ...
                                        {recommendations.recommendations.length === 0 ? (
                                            ...
                                            >
                                                <div className="text-center mb-6">
                                                    ...
                                                    <h4 className="text-lg font-semibold text-gray-800 mb-2">Saran Nutrisi untuk Anda</h4>
                                                    <p className="text-gray-500 text-sm">
                                                        Tidak ada rekomendasi menu spesifik, tetapi kami memiliki saran penting untuk Anda.
                                                    </p>
                                                </div>
                                                ...
                                                {recommendations.advice?.general && (
                                                    <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-5">
                                                        <div className="flex items-start gap-3">
                                                            ...
                                                            <div className="flex-1">
                                                                <h5 className="font-bold text-blue-900 mb-2">Saran Umum</h5>
                                                ...
                                                {recommendations.advice?.nutritional_focus && (
                                                    <div className="bg-amber-50/50 border border-amber-100 rounded-2xl p-5">
                                                        <div className="flex items-start gap-3">
                                                            ...
                                                            <div className="flex-1">
                                                                <h5 className="font-bold text-amber-900 mb-2">Fokus Nutrisi</h5>
