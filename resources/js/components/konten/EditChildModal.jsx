    ...
    const confirmToggleActive = async () => {
        try {
            ...
            if (isCurrentlyActive) {
                ...
                await api.put(`/kader/children/${childId}`, {
                    ...formData,
                    is_active: true,
                });
            ...
            const action = childData?.is_active
                ...
                : "mengaktifkan";
            setError(
                err.response?.data?.message || `Gagal ${action} data anak`,
            );
            setShowDeactivateModal(false);
        } finally {
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-gray-900 ${
                                                        errors.full_name
                                                            ? "border-red-500"
                                                            : "border-gray-200"
                                                    }`}
                            ...
                            <p className="text-gray-500 text-sm mb-6">
                                {childData?.is_active ? (
                                    <>
                                        ...
                                        akan dinonaktifkan dan tidak akan muncul
                                        dalam daftar anak aktif. Anda dapat
                                    ...
                                    <>
                                        ...
                                        akan diaktifkan kembali dan akan muncul
                                        dalam daftar anak aktif.
                                    </>
                                )}
                            </p>
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={deactivating}
                                    className={`flex-1 px-4 py-2.5 text-white rounded-xl font-medium text-sm transition-colors disabled:opacity-50 flex items-center justify-center gap-2 ${
                                        childData?.is_active
