                            ...
                            <div className="divide-y divide-slate-100">
                                {filteredConsultations.map((consultation) => (
                                    <div
                                        ...
                                        onClick={() =>
                                            navigate(
                                                `/dashboard/konsultasi/${consultation.id}`,
                                            )
                                        }
                                        className={`group p-4 hover:bg-slate-50 cursor-pointer transition-colors relative ${
                                            id &&
                                            parseInt(id) === consultation.id
                    ...
                    {id ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center p-8 z-10">
                            <div className="w-80 h-80 mb-6 relative">
                                <div className="absolute inset-0 bg-emerald-100/60 rounded-full blur-3xl opacity-60 animate-pulse" />
                                <div className="relative z-10 w-full h-full flex items-center justify-center">
                                    <div className="w-44 h-44 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 shadow-2xl shadow-emerald-300/40 flex items-center justify-center">
                            ...
                            <p className="text-slate-500 max-w-md text-lg leading-relaxed">
                                Kelola konsultasi dengan orang tua secara
                                real-time. Pilih percakapan di sebelah kiri
                                untuk memulai.
                            </p>
