...
export default function DataAnakDetail() {
    ...
    const paginate = (items, page, perPage) => {
        if (!items || items.length === 0) return { items: [], totalPages: 0 };
    ...
    const PaginationUI = ({ currentPage, totalPages, total, onPageChange, label }) => {
        ...
        return (
            <div className="flex flex-col justify-center items-center gap-3 mt-6 pt-6 border-t border-gray-100">
                ...
                {totalPages > 1 && (
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm text-sm disabled:hover:bg-white"
                        >
                            ...
                            {[...Array(totalPages)].map((_, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`min-w-[32px] h-8 rounded-lg text-sm font-medium transition-all ${isCurrentPage
            ...
            <div className="p-4 md:p-8 w-full max-w-7xl mx-auto flex flex-col gap-6 md:gap-8">
                ...
                <div className="flex flex-col gap-4 md:gap-6">
                    ...
                    <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 min-h-[400px]">
                        ...
                        {activeTab === 'history' && (() => {
                            const historyPagination = paginate(childData.weighing_logs, historyPage, ITEMS_PER_PAGE);
                            const paginatedLogs = historyPagination.items;
                        ...
                        {activeTab === 'meals' && (() => {
                            const mealsPagination = paginate(childData.meal_logs, mealsPage, ITEMS_PER_PAGE);
                            const paginatedMeals = mealsPagination.items;
                                    ...
                                    {(!childData.meal_logs || childData.meal_logs.length === 0) ? (
                                        ...
                                        <>
                                            <div className="relative">
                                                {paginatedMeals.map((log, index) => (
                                                    <div key={log.id} className="relative pl-8 pb-8 last:pb-0">
                                                        {/* Timeline Line */}
                                                        {index !== paginatedMeals.length - 1 && (
                                            ...
                                            <PaginationUI
                                                ...
                                                totalPages={mealsPagination.totalPages}
                                                total={mealsPagination.total}
                        ...
                        {activeTab === 'immunization' && (() => {
                            const immunizationPagination = paginate(childData.immunization_schedules, immunizationPage, ITEMS_PER_PAGE);
                            const paginatedSchedules = immunizationPagination.items;
                                    ...
                                    {(!childData.immunization_schedules || childData.immunization_schedules.length === 0) ? (
                                        ...
                                        <>
                                            ...
                                            <PaginationUI
                                                ...
                                                totalPages={immunizationPagination.totalPages}
                                                total={immunizationPagination.total}
