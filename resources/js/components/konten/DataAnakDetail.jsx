        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors flex items-center gap-2 font-medium"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-red-50 border border-red-100 text-red-600 rounded-xl hover:bg-red-100 transition-colors flex items-center gap-2 font-medium"
            >
            ...
            <div className="flex gap-4 w-full md:w-auto overflow-x-auto pb-2 md:pb-0 no-scrollbar">
              <div className="bg-blue-50/50 p-4 rounded-2xl min-w-[140px] border border-blue-100 flex-shrink-0">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {childData.weight ? `${childData.weight} kg` : '-'}
                </p>
              </div>
              <div className="bg-purple-50/50 p-4 rounded-2xl min-w-[140px] border border-purple-100 flex-shrink-0">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {childData.height ? `${childData.height} cm` : '-'}
                </p>
              </div>
            </div>
          </div>
