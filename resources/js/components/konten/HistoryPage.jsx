            ...
            >
                <div className="px-4 md:px-8 py-4 flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-4 min-w-[200px]">
                        <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center text-lg ${getTypeColor(type)}`}
                        >
                            {getTypeIcon(type)}
                        </div>
                        <div>
                        ...
                        {type === "weighing" && (
                            <div className="flex flex-wrap gap-x-6 gap-y-1">
                                ...
                                {data.nutritional_status && (
                                    <span
                                        className={`px-2 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(data.nutritional_status)}`}
                                    >
                                        {getStatusLabel(
                                            data.nutritional_status,
                                        )}
                            ...
                            <div>
                                ...
                                {data.scheduled_for && (
                                    <p className="text-xs text-gray-500">
                                        Jadwal: {formatDate(data.scheduled_for)}
                                    </p>
                                )}
                            </div>
                        )}
                ...
                <div className="flex flex-col md:flex-row gap-3 items-center justify-between">
                    <div className="flex items-center gap-2 w-full md:w-auto overflow-x-auto no-scrollbar pb-2 md:pb-0">
                                ...
                                <button className="flex items-center gap-2 px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-full text-sm font-medium text-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-100">
                                    ...
                                    <span className="truncate max-w-[120px]">
                                        {filters.child_id
                                            ? children.find(
                                                  (c) =>
                                                      c.id == filters.child_id,
                                              )?.full_name || "Semua Anak"
                                            : "Semua Anak"}
                                    </span>
                                    <Icon
                                        icon="lucide:chevron-down"
                                        className="text-gray-400 w-4 h-4 ml-1"
                                    />
                                </button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent
                                align="start"
                                className="w-48 bg-white rounded-xl shadow-xl border border-gray-100 p-1"
                            >
                                <DropdownMenuItem
                                    onClick={() =>
                                ...
                                <DropdownMenuItem
                                    onClick={() =>
                                        handleFilterChange("type", "weighing")
                                    }
                                    className="rounded-lg cursor-pointer hover:bg-gray-50 focus:bg-gray-50 gap-2"
                                >
                                    <Scale className="w-4 h-4" /> Penimbangan
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    onClick={() =>
                                        handleFilterChange("type", "meal")
                                    }
                                    className="rounded-lg cursor-pointer hover:bg-gray-50 focus:bg-gray-50 gap-2"
                                >
                                    <UtensilsCrossed className="w-4 h-4" />{" "}
                                ...
                                <DropdownMenuItem
                                    ...
                                    className="rounded-lg cursor-pointer hover:bg-gray-50 focus:bg-gray-50 gap-2"
                                >
                                    <Syringe className="w-4 h-4" /> Imunisasi
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                    </div>
