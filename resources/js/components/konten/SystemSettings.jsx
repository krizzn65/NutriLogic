    ...
    return (
        <div className="flex flex-col flex-1 w-full h-full bg-gray-50/50 overflow-hidden font-montserrat">
            <PageHeader
                ...
                subtitle="Konfigurasi sistem NutriLogic"
            >
                <button
                    onClick={handleSave}
                    disabled={saving}
            ...
            <div className="flex-1 overflow-auto p-6 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="space-y-4 max-w-2xl">
                        ...
                        <div>
                            <label
                                htmlFor="system-session-timeout"
                                className="block text-sm font-medium text-gray-700 mb-1"
                            >
                                Timeout Sesi (menit)
                            </label>
                        ...
                        <div>
                            <label
                                htmlFor="system-max-file-size"
                                className="block text-sm font-medium text-gray-700 mb-1"
                            >
                                Ukuran File Maksimal (MB)
                            </label>
                            <input
                                id="system-max-file-size"
                                type="number"
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-800">
                        <strong>Catatan:</strong> Pengaturan ini akan
                        mempengaruhi seluruh sistem. Pastikan Anda memahami
                        dampak dari setiap perubahan sebelum menyimpan.
                    </p>
                </div>
            </div>
        </div>
