...
export default function DataAnakKader() {
    ...
    return (
        ...
        >
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                ...
                <div className="flex flex-col xl:flex-row gap-4 items-end xl:items-center justify-between">
                    <form
                        ...
                        className="flex flex-col md:flex-row gap-4 items-end md:items-center flex-1 w-full"
                    >
                        <div className="w-full md:flex-1">
                            <label
                                htmlFor="data-anak-search"
                        ...
                        <div className="flex flex-row gap-4 w-full md:w-auto">
                            <div className="flex-1 md:w-48">
                                <label
                                    htmlFor="status-gizi-filter"
                                    className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5 block ml-1"
                                >
                                    Status Gizi
                                </label>
                                <select
                                    id="status-gizi-filter"
                                    value={filterStatus}
                                    onChange={(e) =>
                                        setFilterStatus(e.target.value)
                                    }
                                    className="w-full pl-4 pr-10 py-2.5 bg-gray-50 border-transparent focus:bg-white border focus:border-blue-500 rounded-xl focus:ring-4 focus:ring-blue-500/10 transition-all outline-none text-sm text-gray-700"
                                >
                            ...
                            <div className="flex-1 md:w-40">
                                <label
                                    htmlFor="status-aktif-filter"
                                    className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5 block ml-1"
                                >
                                    Status Aktif
                                </label>
                                <select
                                    id="status-aktif-filter"
                                    value={filterActive}
                                    onChange={(e) =>
                    ...
                    <div className="hidden md:flex w-full xl:w-auto flex-shrink-0 gap-2">
                        <div>
                            <p className="text-xs font-semibold text-transparent uppercase tracking-wider mb-1.5 block ml-1 select-none">
                                Print
                            </p>
                            <button
                                className="w-full xl:w-auto px-4 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 transition-all shadow-sm flex items-center justify-center gap-2 font-medium"
                                onClick={handlePrint}
                                type="button"
                            >
            ...
            <button
                onClick={handlePrint}
                className="md:hidden fixed bottom-24 right-20 z-40 w-12 h-12 bg-white text-gray-700 rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-gray-50 transition-all active:scale-95"
                aria-label="Cetak data anak"
                type="button"
            >
                    ...
                    {searchTerm || filterStatus || filterActive !== "1" ? (
                        <>
                            ...
                            <p className="text-gray-500 max-w-sm mx-auto mb-8">
                                ...
                                yang dipilih. Coba ubah filter atau kata kunci
                                pencarian.
                            </p>
                            <button
                        ...
                        <>
                            ...
                            <p className="text-gray-500 max-w-sm mx-auto mb-8">
                                ...
                                Mulai dengan menambahkan data anak baru.
                            </p>
                            <button
                                ...
                                >
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-3">
                                                    ...
                                                    src={
                                                        child.gender === "L"
                                                            ...
                                                            : child.gender ===
                                                              ...
                                                              : `https://api.dicebear.com/9.x/adventurer/svg?seed=${child.full_name}&backgroundColor=b6e3f4`
                                                    }
                                                    alt={child.full_name}
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                                                    {child.gender === "L" ? (
                                                        <span className="text-blue-500 bg-blue-50 px-1.5 py-0.5 rounded text-[10px] font-medium">
                                                            Laki-laki
                                                        </span>
                                                    ) : (
                                                        <span className="text-orange-600 bg-orange-50 px-1.5 py-0.5 rounded text-[10px] font-medium">
                                                            Perempuan
                                                        </span>
                                                    )}
                                        ...
                                        <div className="flex flex-col items-end gap-2">
                                            <span
                                                className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border ${child.is_active ? "bg-green-50 text-green-700 border-green-200" : "bg-red-50 text-red-700 border-red-200"}`}
                                            >
                                                {child.is_active
                                                    ? "Aktif"
                                                    : "Nonaktif"}
                                    ...
                                    <div className="grid grid-cols-2 gap-3 py-3 border-t border-b border-gray-50">
                                        ...
                                        <div>
                                            ...
                                            !status?.measured_at ? (
                                                ...
                                                <span
                                                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(status?.status)} shadow-sm`}
                                                >
                                                    {getStatusLabel(
                                                        status?.status,
                                                    )}
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    !status?.measured_at ? (
                                                        ...
                                                        <span
                                                            className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusColor(status?.status)} shadow-sm`}
                                                        >
                                                            {getStatusLabel(
                                                                status?.status,
                                                            )}
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${child.is_active ? "bg-green-50 text-green-700 border-green-200" : "bg-red-50 text-red-700 border-red-200"}`}
                                                    >
                                                        {child.is_active
                                                            ? "Aktif"
                                                            : "Tidak Aktif"}
            ...
            {children.length > 0 && (
                <div className="flex justify-center items-center gap-2 mt-6">
                    ...
                    <div className="ml-4 text-sm text-gray-600 bg-white px-4 py-2 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        {pagination.last_page} Total: {pagination.total} anak
                    </div>
                </div>
            )}
