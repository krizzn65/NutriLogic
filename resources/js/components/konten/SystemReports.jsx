...
export default function SystemReports() {
    ...
    const handleExport = (type) => {
        ...
        if (selectedPosyandu !== "all")
            params.append("posyandu_id", selectedPosyandu);
    ...
    const handleExportToExcel = () => {
        if (!reportData) {
            setExportError(
                "Tidak ada data yang tersedia untuk di-export. Pastikan data sudah dimuat.",
            );
    ...
    const handleExportChildrenToExcel = async () => {
        try {
            ...
            if (!childrenData || childrenData.length === 0) {
                setExportError(
                    "Tidak ada data anak yang tersedia untuk di-export.",
                );
                setTimeout(() => setExportError(null), 5000);
    ...
    const handleExportWeighingsToExcel = async () => {
        try {
            ...
            const weighingResponse = await api.get("/admin/weighings", {
                params,
            });
            ...
            if (!weighingData || weighingData.length === 0) {
                setExportError(
                    "Tidak ada data penimbangan yang tersedia untuk di-export.",
                );
                setTimeout(() => setExportError(null), 5000);
    ...
    return (
        <div className="flex flex-col flex-1 w-full h-full bg-gray-50/50 overflow-hidden font-montserrat">
            <PageHeader
                ...
                subtitle="Ringkasan statistik dan performa NutriLogic"
            />
                ...
                <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-4 lg:p-5">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">
                            Saring laporan berdasarkan posyandu yang ingin
                            dianalisis.
                        </p>
                    </div>
                    ...
                    <div className="mt-3 flex flex-col md:block gap-3">
                        <div className="flex items-end gap-3">
                            <div
                                ...
                                ref={posyanduRef}
                            >
                                <p className="text-[11px] font-semibold text-gray-500 mb-1 block">
                                    Posyandu
                                </p>
                                <button
                                    onClick={() =>
                                        ...
                                        >
                                            <div className="max-h-64 overflow-y-auto p-1">
                                                <button
                                                    ...
                                                    className="w-full text-left px-3 py-2 rounded-lg hover:bg-blue-50 cursor-pointer flex items-center justify-between group"
                                                >
                                                    <span
                                                        className={`text-sm ${selectedPosyandu === "all" ? "text-blue-600 font-medium" : "text-gray-700"}`}
                                                    >
                                                        Semua Posyandu
                                                    </span>
                                                    {selectedPosyandu ===
                                                ...
                                                {posyandus.map((posyandu) => (
                                                    ...
                                                    >
                                                        <span
                                                            className={`text-sm ${parseInt(selectedPosyandu) === posyandu.id ? "text-blue-600 font-medium" : "text-gray-700"}`}
                                                        >
                                                            {posyandu.name}
                                                        </span>
                                                        {parseInt(
                ...
                {reportData && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {reportData?.summary?.total_posyandu ??
                                            0}
                                    </p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {reportData?.summary?.total_kader ?? 0}
                                    </p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {reportData?.summary?.total_ibu ?? 0}
                                    </p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {reportData?.summary?.total_anak ?? 0}
                                    </p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {reportData?.summary?.total_weighings ??
                                            0}
                                    </p>
                                </div>
                            </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <motion.div
                                variants={itemVariants}
                                className="hidden md:flex bg-white rounded-3xl shadow-sm border border-gray-100 p-6 flex-col gap-3"
                            >
                                        ...
                                        <table className="min-w-full text-sm">
                                            ...
                                            <tbody className="divide-y divide-gray-100">
                                                {growthByPosyandu.map((row) => (
                                                    <tr
                                                        key={`${row.month}-${row.children_count}`}
                                                        className="hover:bg-gray-50"
                                                    >
                                                        <td className="px-4 py-2 font-medium text-gray-800">
                                                            {row.month}
