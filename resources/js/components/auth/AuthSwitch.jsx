...
function GlassInput({ icon, error, children, className = "" }) {
    ...
    return (
        ...
        >
            <div className={`relative flex items-center overflow-hidden rounded-xl border transition-all duration-300 ${error
                ? 'border-red-500/40 bg-red-500/10'
                : focused
                    ? 'border-[#00BFEF]/60 bg-white/60 shadow-[0_0_15px_rgba(0,191,239,0.15)]'
                    : 'border-white/40 bg-white/40 hover:border-white/60'
                }`}>
                <div className={`absolute left-3.5 transition-all duration-300 ${focused ? 'text-[#00BFEF]' : error ? 'text-red-400' : 'text-gray-400'
                    }`}>
                ...
                {React.Children.map(children, child => {
                    ...
                    if (child.type === 'input' || child.type === 'textarea') {
                        return React.cloneElement(child, {
                            ...
                            className: `w-full bg-transparent text-gray-800 placeholder:text-gray-400 outline-none transition-all duration-300 ${child.type === 'textarea'
            ...
            {message && (
                ...
                >
                    <div className="px-3.5 py-2.5 bg-red-500/10 border border-red-300/40 rounded-xl text-red-500 text-xs font-medium flex items-center gap-2.5 backdrop-blur-sm">
                        <Icon icon="solar:danger-circle-bold-duotone" className="text-base flex-shrink-0" />
                        <span>{message}</span>
                    </div>
                </motion.div>
            )}
...
export default function AuthSwitch() {
    ...
    const validateEmail = (email) => {
        ...
        if (email.includes('..')) return 'Email tidak boleh mengandung titik ganda berturut-turut.';
        if (email.startsWith('.') || email.endsWith('.')) return 'Email tidak boleh diawali atau diakhiri dengan titik.';
        return null;
    };

    const validatePhone = (phone) => {
        const phoneRegex = /^(08|62)\d{8,13}$/;
        if (!phoneRegex.test(phone)) return 'Format nomor telepon tidak valid. Gunakan format 08xxxxxxxxxx atau 62xxxxxxxxxx.';
        return null;
    };
    ...
    return (
        ...
        >
            ...
            <div className="absolute right-1/4 bottom-1/4 w-80 h-80 bg-[#00BFEF]/6 rounded-full blur-[100px] animate-pulse opacity-50" style={{ animationDelay: '1s' }} />
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-white/55 backdrop-blur-2xl rounded-2xl border border-white/50 shadow-2xl shadow-[#00BFEF]/10 overflow-hidden">
                            ...
                            <div
                                ...
                                style={isSignUp ? {
                                    scrollbarWidth: 'thin',
                                    scrollbarColor: 'rgba(0,191,239,0.3) rgba(0,0,0,0.03)'
                                } : {}}
                            >
                                {/* ===== SIGN IN VIEW ===== */}
                                <div style={{ display: isSignUp ? 'none' : 'block' }}>
                                    ...
                                    <div className="text-center space-y-1.5 mb-6">
                                        <div className="mx-auto w-12 h-12 rounded-full border border-[#00BFEF]/20 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#00BFEF]/10 to-[#e0f4ff]">
                                            <Icon icon="mdi:heart-pulse" className="text-[#00BFEF] text-xl" />
                                    ...
                                    <form onSubmit={handleSignIn} className="space-y-3.5" autoComplete="off">
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                disabled={loading}
                                            >
                                                <Icon icon={showPassword ? "mdi:eye-off" : "mdi:eye"} className="w-[18px] h-[18px]" />
                                            </button>
                                        </div>
                                            ...
                                            <div className="relative overflow-hidden bg-gradient-to-r from-[#00BFEF] to-[#0088c2] text-white font-semibold h-11 rounded-xl transition-all duration-300 flex items-center justify-center shadow-lg shadow-[#00BFEF]/20">
                                                ...
                                                <AnimatePresence mode="wait">
                                                    {loading ? (
                                                        ...
                                                        >
                                                            Masuk
                                                            <Icon icon="mdi:arrow-right" className="w-4 h-4 group-hover/button:translate-x-1 transition-transform duration-300" />
                                                        </motion.span>
                                                    )}
                                                </AnimatePresence>
                                            </div>
                                        ...
                                        <div className="relative flex items-center my-4">
                                            ...
                                            <span className="mx-3 text-[11px] text-gray-400">atau</span>
                                            <div className="flex-grow border-t border-gray-300/40" />
                                        </div>
                                ...
                                <div style={{ display: isSignUp ? 'block' : 'none' }}>
                                    ...
                                    <div className="text-center space-y-1.5 mb-5">
                                        <div className="mx-auto w-12 h-12 rounded-full border border-[#00BFEF]/20 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#00BFEF]/10 to-[#e0f4ff]">
                                            <Icon icon="mdi:account-plus" className="text-[#00BFEF] text-xl" />
                                            <div className="absolute inset-0 bg-gradient-to-br from-white/30 to-transparent opacity-50" />
                                        </div>
                                    ...
                                    <form onSubmit={handleSignUp} className="space-y-2.5" autoComplete="off">
                                        ...
                                        <GlassInput icon="mdi:account" error={fieldErrors.name}>
                                            <input
                                                type="text"
                                        ...
                                        <GlassInput icon="mdi:email" error={fieldErrors.email}>
                                            <input
                                                type="email"
                                                placeholder="Email"
                                                autoComplete="email"
                                        ...
                                        <GlassInput icon="fluent:phone-16-filled" error={fieldErrors.phone}>
                                            <input
                                                type="tel"
                                        ...
                                        <div className="relative">
                                            <div
                                                className={`relative flex items-center overflow-visible rounded-xl border transition-all duration-300 cursor-pointer ${fieldErrors.posyandu_id
                                                    ? 'border-red-500/40 bg-red-500/10'
                                            ...
                                            >
                                                <div className={`absolute left-3.5 transition-all duration-300 ${isPosyanduDropdownOpen ? 'text-[#00BFEF]' : fieldErrors.posyandu_id ? 'text-red-400' : 'text-gray-400'
                                                    }`}>
                                                    <Icon icon="mdi:hospital-building" className="w-[18px] h-[18px]" />
                                                </div>
                                                <div className="w-full pl-11 pr-10 h-11 flex items-center">
                                                    <span className={`text-sm ${signUpData.posyandu_id ? 'text-gray-800 font-medium' : 'text-gray-400'}`}>
                                                ...
                                                <div className="absolute right-3 text-gray-400">
                                                    <Icon
                                                        ...
                                                        style={{ transform: isPosyanduDropdownOpen ? 'rotate(180deg)' : 'rotate(0deg)' }}
                                                    />
                                                </div>
                                            </div>
                                                            ...
                                                            {posyandus.length === 0 ? (
                                                                ...
                                                                posyandus.map((posyandu) => (
                                                                    <div
                                                                        ...
                                                                        className={`px-4 py-2.5 cursor-pointer flex items-center justify-between transition-all duration-200 hover:bg-[#00BFEF]/5 ${parseInt(signUpData.posyandu_id) === posyandu.id ? 'bg-[#00BFEF]/10' : ''
                                                                            }`}
                                                                    >
                                                                        <span className={`text-sm ${parseInt(signUpData.posyandu_id) === posyandu.id
                                                                        ...
                                                                        {parseInt(signUpData.posyandu_id) === posyandu.id && (
                                                                            <Icon icon="mdi:check" className="text-[#00BFEF] text-lg" />
                                                                        )}
                                                                    </div>
                                                                ))
                                                            )}
                                        ...
                                        <div className="flex gap-2.5">
                                            <GlassInput icon="mdi:home-group" error={fieldErrors.rt} className="flex-1">
                                                <input
                                                    type="text"
                                                    placeholder="RT"
                                                    autoComplete="off"
                                            ...
                                            <GlassInput icon="mdi:home-city" error={fieldErrors.rw} className="flex-1">
                                                <input
                                                    type="text"
                                                    placeholder="RW"
                                                    autoComplete="off"
                                        ...
                                        {/* Alamat */}
                                        <GlassInput icon="mdi:map-marker" error={fieldErrors.address}>
                                            <textarea
                                        ...
                                        {/* Password */}
                                        <div className="relative">
                                            <GlassInput icon="material-symbols:lock" error={fieldErrors.password}>
                                                <input
                                            ...
                                            <button
                                                ...
                                                disabled={signUpLoading}
                                            >
                                                <Icon icon={showSignUpPassword ? "mdi:eye-off" : "mdi:eye"} className="w-[18px] h-[18px]" />
                                            </button>
                                        </div>

                                        {/* Konfirmasi Password */}
                                        <div className="relative">
                                            <GlassInput icon="material-symbols:lock-outline" error={fieldErrors.confirmPassword}>
                                                <input
                                            ...
                                            <button
                                                ...
                                                disabled={signUpLoading}
                                            >
                                                <Icon icon={showConfirmPassword ? "mdi:eye-off" : "mdi:eye"} className="w-[18px] h-[18px]" />
                                            </button>
                                        </div>
                                        ...
                                        <p className="text-center text-xs text-gray-500">
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => { setIsSignUp(false); setSignUpError(''); setFieldErrors({}); }}
