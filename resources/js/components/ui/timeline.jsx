      ...
      <div ref={ref} className="relative w-full pb-20">
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-[#00BFEF]/20 border border-[#00BFEF] p-2" />
              </div>
              <h3
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#00BFEF] via-[#0088c2] to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>
  );
